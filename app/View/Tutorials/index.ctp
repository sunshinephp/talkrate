...
if ($isAdmin) {
	?>
	<section class="tools">
		<?php echo $this->Html->link('Add Tutorial', array('controller' => 'talks', 'action' => 'add'), array('class' => array('btn', 'btn-primary'))); ?>
		<?php echo $this->Html->link('Upload Tutorial', array('controller' => 'talks', 'action' => 'upload'), array('class' => array('btn'))); ?>
	</section>
	<?php
}
