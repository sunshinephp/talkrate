...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tutorial'), array('action' => 'edit', $talk['Talk']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tutorial'), array('action' => 'delete', $talk['Talk']['id']), null, __('Are you sure you want to delete # %s?', $talk['Talk']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Tutorial'), array('action' => 'index')); ?> </li>
...
<div class="related">
	<h3><?php echo __('Related Tutorial Ratings'); ?></h3>
